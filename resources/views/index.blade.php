 ...
 <!-- Choices.js-->
  ...
  <body>
    ...
    <div class="d-flex align-items-stretch">
      ...
      <nav id="sidebar">
        <!-- Sidebar Header-->
        <div class="sidebar-header d-flex align-items-center p-4"><img class="avatar shadow-0 img-fluid rounded-circle" src="{{asset('assets/img/avatar-6.jpg')}}" alt="...">
            ...
            <div class="row gy-4">
                    ...
                    <div class="card">
                      <div class="card-body">
                        <div class="text-center">
                          <div class="position-relative d-inline-block"><img class="avatar avatar-lg mb-3" src="{{asset('assets/img/avatar-1.jpg')}}" alt="Richard Nevoreski"><span class="avatar-badge bg-dash-color-1">1st</span></div>
              ...
              <div class="col-lg-4">
                    ...
                    <div class="card">
                      <div class="card-body">
                        <div class="text-center">
                          <div class="position-relative d-inline-block"><img class="avatar avatar-lg mb-3" src="{{asset('assets/img/avatar-4.jpg')}}" alt="Samuel Watson"><span class="avatar-badge bg-dash-color-2">2nd</span></div>
              ...
              <div class="col-lg-4">
                    ...
                    <div class="card">
                      <div class="card-body">
                        <div class="text-center">
                          <div class="position-relative d-inline-block"><img class="avatar avatar-lg mb-3" src="{{asset('assets/img/avatar-6.jpg')}}" alt="Sebastian Wood"><span class="avatar-badge bg-dash-color-3">3rd</span></div>
                    ...
                    <div class="card">
                      <div class="card-body">
                        <div class="row gy-3 align-items-center">
                          <div class="col-lg-4">
                            <div class="d-flex align-items-center"><strong class="text-sm d-none d-lg-block">4th</strong><img class="avatar ms-3" src="{{asset('assets/img/avatar-1.jpg')}}" alt="Tomas Hecktor">
                              <div class="ms-3">
              ...
              <div class="col-12">
                    <div class="card">
                      <div class="card-body">
                        <div class="row gy-3 align-items-center">
                          <div class="col-lg-4">
                            <div class="d-flex align-items-center"><strong class="text-sm d-none d-lg-block">5th</strong><img class="avatar ms-3" src="{{asset('assets/img/avatar-2.jpg')}}" alt="Alexander Shelby">
                              <div class="ms-3">
